      ...
      <div className="w-full max-w-6xl">
        <div className="mb-16 text-center">
          <h2 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">
            Sobre <span className="text-violet-600">Mí</span>
          </h2>
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div className="space-y-6">
            <p className="text-lg leading-relaxed text-slate-600">
              Soy estudiante de <span className="font-semibold text-violet-600">Ingeniería de Software</span> con
              una profunda pasión por crear soluciones tecnológicas innovadoras. Mi enfoque está en el{' '}
              <span className="font-semibold text-blue-700">aprendizaje constante</span> y la mejora continua.
            </p>
            <p className="text-lg leading-relaxed text-slate-600">
              ...
              <span className="font-semibold text-amber-600">programación</span> como herramienta para
              transformar ideas en realidad.
            </p>
            <p className="text-lg leading-relaxed text-slate-600">
              Además de la tecnología, el <span className="font-semibold text-violet-600">deporte</span> es parte
              fundamental de mi vida, enseñándome disciplina, perseverancia y trabajo en equipo.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-6">
            <div className="rounded-2xl border border-violet-200 bg-white/80 p-6 shadow-lg shadow-violet-100/60 transition-all duration-300 hover:scale-105">
            ...
            <div className="rounded-2xl border border-amber-200 bg-white/80 p-6 shadow-lg shadow-amber-100/60 transition-all duration-300 hover:scale-105">
